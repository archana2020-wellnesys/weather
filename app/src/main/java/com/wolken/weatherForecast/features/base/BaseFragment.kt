package com.wolken.weatherForecast.features.base
...
import com.wolken.weatherForecast.injection.component.DaggerConfigPersistentComponent
import com.wolken.weatherForecast.injection.component.FragmentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentsArray.get(fragmentId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(WeatherForecastStarterApplication[activity as Context].component)
                    .build()
